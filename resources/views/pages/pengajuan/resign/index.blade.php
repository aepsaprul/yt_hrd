                            ...
                            <table id="example1" class="table table-bordered table-striped" style="font-size: 13px;">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center text-indigo">Alasan Resign</th>
            ...
            <form id="form" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <small id="error_tanggal_keluar" class="form-text text-danger"></small>
                    </div>
                    <div class="mb-3">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#btn-create').on('click', function() {
            $.ajax({
                url: "{{ URL::route('pengajuan_resign.create') }}",
                type: 'GET',
        ...
        $(document).on('submit', '#form', function (e) {
            ...
            $('#error_nama').empty();
            $('#error_tanggal_keluar').empty();
            $('#error_alasan').empty();

            var formData = new FormData($('#form')[0]);

            $.ajax({
                url: "{{ URL::route('pengajuan_resign.store') }}",
                type: 'POST',
                data: formData,
                contentType: false,
                processData: false,
                ...
                success: function (response) {
                    if (response.status == 400) {
                        ...
                        $('#error_tanggal_keluar').append(response.errors.tanggal_keluar);
