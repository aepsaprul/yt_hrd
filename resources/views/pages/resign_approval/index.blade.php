...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Resign Approval</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Resign Approval</li>
                    </ol>
                </div>
            </div>
        </div>
                                    ...
                                    @foreach ($resign_details as $key => $item)
                                        ...
                                        @else
                                            <tr>
                                                ...
                                                <td>{{ $item->resign->karyawan->nama_lengkap }}</td>
                                                <td>{{ $item->resign->alasan }}</td>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '.btn-approve', function (e) {
            ...
            let url = '{{ route("resign_approval.approved", ":id") }}';
        ...
        $(document).on('click', '.btn-disapprove', function (e) {
            ...
            let id = $(this).attr('data-id');
            let url = '{{ route("resign_approval.disapproved", ":id") }}';
            url = url.replace(':id', id);
        ...
        $(document).on('click', '.btn-detail', function (e) {
            ...
            var url = '{{ route("resign_approval.show", ":id") }}';
            url = url.replace(':id', id);
